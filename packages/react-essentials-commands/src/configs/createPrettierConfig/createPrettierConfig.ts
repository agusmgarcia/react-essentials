 ...
 *
 * @param core - The core type that determines the configuration. Supported values include "azure-func", "node", "app", and others.
 ...
 */
export default function createPrettierConfig(...[core]: Input): Output {
  if (core === "azure-func" || core === "node") return {};

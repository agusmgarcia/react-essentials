import { type BrowserStorageSliceTypes } from "#src/BrowserStorageSlice";
 ...
 */
export type BaseData = BrowserStorageSliceTypes.BaseData;
 ...
 */
export type BaseSlices = BrowserStorageSliceTypes.BaseSlices;

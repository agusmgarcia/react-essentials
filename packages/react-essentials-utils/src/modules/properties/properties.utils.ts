 ...
 * @param omit - An optional array of nested property paths to omit from sorting at the current depth.
 *               When a path matches, the children of that object are not sorted at that level,
 *               but recursion still continues into deeper descendants.

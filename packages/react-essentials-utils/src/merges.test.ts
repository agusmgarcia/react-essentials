...
describe("merges", () => {
  ...
  describe("shallow", () => {
    ...
    it("should handle shallow merging", () => {
      const base = { a: ["z", "x", "y"] };
      const next = { a: ["b", "a", "c"] };
      expect(merges.shallow(base, next, { level: 2 })).toEqual({
        a: ["z", "x", "y", "b", "a", "c"],
    ...
    it("should handle shallow merging with nested arrays", () => {
      const base = { a: { b: [9, 7, 8] } };
      const next = { a: { b: [6, 5, 4] } };
      expect(merges.shallow(base, next, { level: 3 })).toEqual({
        a: { b: [9, 7, 8, 6, 5, 4] },
      });
    });
    ...
    it("should handle shallow merging with mixed data types", () => {
      const base = { a: [3, "b", 1] };
      const next = { a: [2, "a", 4] };
      expect(merges.shallow(base, next, { level: 2 })).toEqual({
        a: [3, "b", 1, 2, "a", 4],
  ...
  describe("deep", () => {
    ...
    it("should deeply merge objects with nested arrays", () => {
      const base = { a: { b: [9, 7, 8] } };
      const next = { a: { b: [6, 5, 4] } };
      expect(merges.deep(base, next)).toEqual({
        a: { b: [9, 7, 8, 6, 5, 4] },
